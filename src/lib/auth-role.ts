 ...
 * with no customer). Drives sidebar link visibility, the Customers/
 * Projects route enforcement in proxy.ts, home-route redirects, and the
 * Poles/Projects pages' own data scoping — kept here as the single
 * source of truth so those can't drift out of sync with each other.
 */
